...
| [08-模型说明](./docs/08-模型说明.md) | SAM 系列模型、权重下载和模型选择 |
| [09-点标注参数与结果说明](./docs/09-点标注参数与结果说明.md) | Web 点标注的参数、结果和排错 |
| [10-RemoteSAM对比与功能介绍](./docs/10-RemoteSAM对比与功能介绍.md) | RemoteSAM 源码级分析、快速开始和本项目对比 |
| [11-Web平台使用手册](./docs/11-Web平台使用手册.md) | Web 平台完整操作流程和结果解释 |
| [12-SAM处理逻辑详解](./docs/12-SAM处理逻辑详解.md) | 从影像加载到 Mask、后处理和矢量导出的处理链路 |
| [13-模型详解与参数说明](./docs/13-模型详解与参数说明.md) | 本项目与 RemoteSAM 涉及模型的命名、作用、参数和用法 |
