...
def main():
 p=argparse.ArgumentParser();p.add_argument('--host',default='127.0.0.1');p.add_argument('--backend-port',type=int,default=8023);p.add_argument('--frontend-port',type=int,default=5183);p.add_argument('--no-install',action='store_true');p.add_argument('--no-browser',action='store_true');a=p.parse_args()
